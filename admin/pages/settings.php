...
<label class="control-label mb-10" for="exampleInputuname_1">Service Charge</label>
<div class="input-group">
<div class="input-group-addon"><i class="fa fa-text-width"></i></div>
<input type="float" class="form-control" id="exampleInputuname_1" placeholder="Full Name" name="services" <?php if(isset($_GET["edit"])){?>value="<?php echo $data[0]["services"] ?>"<?php }?> required>
</div>
</div>
</div>
...
<div class="col-md-3">
<div class="form-group">
<label class="control-label mb-10" for="exampleInputuname_1">Delivery Charge</label>
<div class="input-group">
<div class="input-group-addon"><i class="fa fa-text-width"></i></div>
<input type="float" class="form-control" id="exampleInputuname_1" placeholder="Enter delivery charges" name="delivery" <?php if(isset($_GET["edit"])){?>value="<?php echo $data[0]["delivery"] ?>"<?php }?> required>
</div>
</div>
</div>	
