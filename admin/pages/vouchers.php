...
<td><?php @$data = selectDB("vendors"," `id` LIKE '".$row["vendorId"]."'"); if ( isset($data[0]["username"]) ){ echo $data[0]["username"]; }else{ echo "None";}?></td>
<td><?php if ( $row["is_all"] == 0 ) { echo "No"; } else {echo "Yes"; } ?></td>
<td>
