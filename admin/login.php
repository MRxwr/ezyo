...
if ( isset($_POST["username"]) && !empty($_POST["username"] )){
	...
	if ( $user = selectDBNew("user",[$_POST['username'],sha1($_POST['password'])],"`username` LIKE ? AND `password` LIKE ? AND `status` LIKE '0'","") ){
	...
	<body>
			...
			<header class="sp-header">
				<div class="sp-logo-wrap pull-left">
					<a href="index.html">
						...
						<span class="brand-text">EZYO</span>
					</a>
				</div>
							...
							<div class="auth-form  ml-auto mr-auto no-float">
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Employee Sign in to EZYO CP</h3>
		...
		<form action="" method="post">
			...
			<div class="form-group text-center">
				...
				<a href="vendorLogin.php" class="btn btn-warning  btn-rounded">I am a vendor</a>
			</div>
		</form>
										</div>
									</div>	
