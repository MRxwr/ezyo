...
class _EditAddressScreenState extends State<EditAddressScreen> {
  ...
  void initState() {
    ...
    super.initState();
    _CountryCountroller.text = widget.address.country;
    ...
    _HouseNoController.text = widget.address.house;
    _AvenueController.text = widget.address.avenue;
    _FloorController.text = widget.address.floor;
    _FlatController.text = widget.address.flat;
  }
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  decoration: new InputDecoration(
                                    contentPadding: EdgeInsets.all(6.w),
                                    hintText: getTranslated(context, 'mobile_string'),
                                    hintStyle: TextStyle(
                                        color: Color(0xFF747474),
                                        fontSize: screenUtil.setSp(15),
                                        fontWeight: FontWeight.normal
  ...
  void validate(BuildContext context) async {
    ...
    if(widget._globalKey.currentState.validate()) {
      ...
      String addressId = widget.address.id;
      SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
      String userId = sharedPreferences.getString("id");
      final modelHud = Provider.of<ModelHud>(context, listen: false);
      modelHud.changeIsLoading(true);
      EzyoServices ezyoServices = EzyoServices();
      AddAddress.AddAddressModel addressModel = await  ezyoServices.EditAddress(addressId, name, country, area, block, street, houseNo, floor, flat, phone,avenue);
