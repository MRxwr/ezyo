...
class _SettingsScreenState extends State<SettingsScreen> {
 ...
 showDeletionDialog(BuildContext context) async{
    ...
    alert =   Alert(
      ...
      title: getTranslated(context, 'Are_u_sure'),
  ...
  void deleteAccount(BuildContext context)async{
    ...
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    String userId = sharedPreferences.getString("id")??"";
    DeleteAccountModel deleteAccountModel = await ezyoServices.deleteAccount(userId);
    bool isOk = deleteAccountModel.ok;
    ...
    _scaffoldKey.currentState.showSnackBar(
        SnackBar(content: Text(deleteAccountModel.data.msg)));
  }
}
